...
void make_tree(int **picture, const int tree_trunk[4], const int tree_foliage[4]);
void make_window(int **picture, int length_frame_h, int length_frame_w, const int *frame_h,
                 const int *frame_w);
void make_sun(int **picture, int m, const int sun_data[6][5]);
...
void make_picture(int **picture, int n, int m) {
    ...
    make_sun(picture, m, sun_data);
    make_tree(picture, tree_trunk, tree_foliage);
    make_window(picture, length_frame_h, length_frame_w, frame_h, frame_w);
}
